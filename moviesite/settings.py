...
SECRET_KEY = 'django-insecure-cr+(qwice^gd!zf1^g&+)z*h2_@&q6colp%6f-w!&3y#2a$_=y'
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # adicione esta linh
